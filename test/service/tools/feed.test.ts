...
describe("feed tests", () => {
  ...
  describe("mapEmailDetailsListToFeed", () => {
    test("map feed with no items", () => {
      // given
      jest.useFakeTimers().setSystemTime(new Date("2023-01-01 01:01:01"));
      // and
      ...
      expect(result).toEqual(
        '<?xml version="1.0" encoding="utf-8"?>\n' +
          ...
          "        <lastBuildDate>Sun, 01 Jan 2023 00:01:01 GMT</lastBuildDate>\n" +
      ...
      const emails: EmailDetails[] = [
        {
          ...
          subject: "subject",
          body: "body",
          received: new Date("2024-01-01 01:01:01"),
        },
      ];
      const username = "username";
      const token = "token";
